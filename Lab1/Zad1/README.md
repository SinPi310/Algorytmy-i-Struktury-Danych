...
```
| Method          | M   | Mean             | Error           | StdDev          | Allocated |
|---------------- |---- |-----------------:|----------------:|----------------:|----------:|
| Silowe    O(N3) | 100 |   3,208,585.2 ns |    54,130.93 ns |    50,634.10 ns |         - |
| Optymalne O(N2) | 100 |      15,674.8 ns |       273.19 ns |       255.54 ns |         - |
| Fassttt pureMath| 100 |         195.3 ns |         3.04 ns |         2.84 ns |         - |
| Silowe    O(N3) | 500 | 383,085,906.7 ns | 5,995,003.49 ns | 5,607,729.98 ns |         - |
| Optymalne O(N2) | 500 |     374,418.8 ns |     4,824.90 ns |     4,513.22 ns |         - |
| Fassttt pureMath| 500 |       1,196.2 ns |        15.72 ns |        14.71 ns |         - |
